...
var ControlButton = function ControlButton(_ref) {
  ...
  return React__default.createElement(reactTinyPopover.Popover, {
    isOpen: menuVisible,
    positions: ["top"],
    content: menu
  }, React__default.createElement("div", {
...
var AudioSelectButton = function AudioSelectButton(_ref) {
  ...
  var listAudioDevices = React.useCallback(function () {
    try {
      return Promise.resolve(livekitClient.Room.getLocalDevices("audioinput")).then(function (devices) {
        setSources(devices);
  ...
  return React__default.createElement(ControlButton, {
    ...
    icon: isMuted ? freeSolidSvgIcons.faMicrophoneSlash : freeSolidSvgIcons.faMicrophone,
...
var VideoSelectButton = function VideoSelectButton(_ref) {
  ...
  var listVideoDevices = React.useCallback(function () {
    try {
      return Promise.resolve(livekitClient.Room.getLocalDevices("videoinput")).then(function (devices) {
        setSources(devices);
        setMenuItems(devices.map(function (item) {
          return {
            label: item.label
  ...
  return React__default.createElement(ControlButton, {
    ...
    icon: isEnabled ? freeSolidSvgIcons.faVideo : freeSolidSvgIcons.faVideoSlash,
    disabled: isButtonDisabled,
    onClick: onClick,
    menuItems: menuItems,
    onMenuItemClick: handleMenuItem,
...
var VideoRenderer = function VideoRenderer(_ref) {
  ...
  var isFrontFacing = isLocal && ((_track$mediaStreamTra = track.mediaStreamTrack) === null || _track$mediaStreamTra === void 0 ? void 0 : _track$mediaStreamTra.getSettings().facingMode) !== "environment";
  var style = {
  ...
  return React__default.createElement("video", {
    ref: ref,
    className: className != null ? className : styles.video,
    style: style
  });
};
...
var ParticipantView = function ParticipantView(_ref) {
  ...
  var handleResize = React.useCallback(function (width, height) {
  ...
  React.useEffect(function () {
    var interval = setInterval(function () {
      ...
      participant.tracks.forEach(function (pub) {
        if (pub.track instanceof livekitClient.LocalTrack || pub.track instanceof livekitClient.RemoteTrack) {
...
function defaultSortParticipants(participants) {
  ...
  var localParticipant = sortedParticipants.find(function (p) {
    return p instanceof livekitClient.LocalParticipant;
  });
...
var SpeakerStage = function SpeakerStage(_ref) {
  ...
  var _useState2 = React.useState(sortFn(participants)),
  ...
  sortedParticipants.forEach(function (p) {
    ...
    var track = p.getTrack(livekitClient.Track.Source.ScreenShare);
...
var StageView = function StageView(stageProps) {
  ...
  return React__default.createElement("div", {
    ...
    className: styles.icon,
    size: "1x",
    icon: freeSolidSvgIcons.faVolumeMute
  }), "Click to Unmute")));
};
...
function useRoom(roomOptions) {
  var _useState = React.useState(),
      currentRoom = _useState[0],
      setCurrentRoom = _useState[1];
  ...
  var connectFn = React.useCallback(function (url, token, options) {
    try {
      ...
      return Promise.resolve(_catch(function () {
        var room = new livekitClient.Room(roomOptions);
...
exports.AudioSelectButton = AudioSelectButton;
...
exports.ScreenShareView = ScreenShareView;
exports.StageView = StageView;
exports.VideoRenderer = VideoRenderer;
exports.VideoSelectButton = VideoSelectButton;
